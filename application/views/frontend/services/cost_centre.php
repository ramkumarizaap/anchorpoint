<div class=" container-fluid inner-page"> 
    ...
    <!-- Three columns of text below the carousel -->
  	<div class="row">
			...
			<div class="col-md-2">
				<a href="javascript:;" class="btn btn-primary pull-right" data-remodal-target="modal">+ Add Cost Centre</a>
			</div>
		</div><br>
    <div class="row">
      <div class="col-lg-12"> 
 ...
 <div class="remodal" data-remodal-id="modal">
  ...
  <form method="post" id="costForm" action="">
    <input type="hidden" name="form_id" value="costForm">
    <input type="hidden" name="action" value="cost_centre">
